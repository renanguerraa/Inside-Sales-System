...
<html>
    ...
    <body>
        ...
        <h1>Editar - <span class="badge badge-warning">Categoria</span></h1> <br>
            ...
            <form action="salvarEdicao.php" method="POST">
                <div>
                    ...
                    <label>Nome: </label> 
                    <input type="text" name="txtNome" value="<?php echo $resultado["nome"] ?>" class="form-control" required/> <br>                        
