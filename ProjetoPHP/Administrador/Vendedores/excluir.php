...
<html>
    ...
    <body>
        <div class="container bg-light">
            ...
            <h1>Excluir - <span class="badge badge-warning">Vendedor</span></h1> <br>
            ...
            <form action="salvarExclusao.php" method="POST">
                <div>
                    ...
                    <label>Nome: </label> 
                    <input type="text" name="txtNome" readonly="readonly" value="<?php echo $resultado["nome_vend"] ?>" class="form-control"/> <br>                            
